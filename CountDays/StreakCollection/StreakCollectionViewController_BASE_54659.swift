...
//        collectionView?.register(StreakCollectionViewFooter.self, forSupplementaryViewOfKind: UICollectionElementKindSectionFooter, withReuseIdentifier: "myFooterView")
//        currentDay = changeToMidnight(toChange: currentDay)
...
//            layout.footerReferenceSize = CGSize(width: view.safeAreaLayoutGuide.layoutFrame.width, height: view.safeAreaLayoutGuide.layoutFrame.height)
        }
    }
